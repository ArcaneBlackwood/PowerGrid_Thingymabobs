...
public class PoisonousPotatoBatteryBlockCT extends ConnectedTextureBehaviour.Base {
	...
	private static final CTSpriteShiftEntry SIDES = CTSpriteShifter.getCT(
                AllCTTypes.RECTANGLE,
                MoreGrid.asResource("block/battery/poisonous_potato_battery_side"),
                MoreGrid.asResource("block/battery/poisonous_potato_battery_side_connected")
	);

	private static final CTSpriteShiftEntry SIDES_BAKED = CTSpriteShifter.getCT(
                AllCTTypes.RECTANGLE,
                MoreGrid.asResource("block/battery/baked_poisonous_potato_battery_side"),
                MoreGrid.asResource("block/battery/baked_poisonous_potato_battery_side_connected")
	);
