...
public class PoisonousPotatoBatteryArray extends APotatoBatteryArray implements CustomModelItemRenderer.Provider {
    ...
    protected static final PartialModel MODEL = CustomModelItemRenderer.generateModel("block/battery/poisonous_potato_battery_array_v");
    protected static final PartialModel MODEL_BAKED = CustomModelItemRenderer.generateModel("block/battery/baked_poisonous_potato_battery_array_v");
    @Override
