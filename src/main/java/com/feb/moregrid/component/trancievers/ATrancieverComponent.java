...
import com.feb.moregrid.mixin.ISynchronizedComponent;
...
public abstract class ATrancieverComponent extends MirrorableComponent implements IRenderedComponent, IComponentGoggleInformation, IInteractableComponent, ISynchronizedComponent {
    public static final ComponentFootprint FOOTPRINT = new ComponentFootprint.Builder(
				7,3, "component." + MoreGrid.MOD_ID + ".tranciever", null)
            .addPad(5, 0, 0, "Power -", "-")
            .addPad(5, 2, 1, "Power +", "+")
	...
	public static final ConstantProperty PROP_POWER_VOLTAGE = new ConstantProperty(MoreGrid.MOD_ID, "tranciever.power_voltage",
		Unit.VOLTAGE.formatWithPrefixes(POWER_VOLTAGE).component());
	public static final ConstantProperty PROP_POWER_MIN = new ConstantProperty(MoreGrid.MOD_ID, "tranciever.power_min",
		Unit.POWER.formatWithPrefixes(POWER_WATTS_MIN).component());
	public static final ConstantProperty PROP_TOTAL_POWER_MAX = new ConstantProperty(MoreGrid.MOD_ID, "tranciever.total_power_max",
		Unit.POWER.formatWithPrefixes(POWER_WATTS + SIGNAL_WATTS).component());
	public static final ItemProperty PROP_SLOT1 = new ItemProperty(MoreGrid.MOD_ID, "tranciever.slot1").hidden().cast();
	public static final ItemProperty PROP_SLOT2 = new ItemProperty(MoreGrid.MOD_ID, "tranciever.slot2").hidden().cast();

	public static final ConstantProperty PROP_TRANSMIT_CURRENT_FULL = new ConstantProperty(MoreGrid.MOD_ID, "tranciever.transmit_current_full",
		Unit.CURRENT.formatWithPrefixes(TRANSMIT_CURRENT_FULL).component());
	public static final ConstantProperty PROP_TRANSMIT_RESISTANCE = new ConstantProperty(MoreGrid.MOD_ID, "tranciever.transmit_resistance",
    ...
    public static final FloatProperty PROP_RECIEVE_RESISTANCE_MIN = 
		new FloatProperty(MoreGrid.MOD_ID, "tranciever.recieve_resistance_min",  1_000f, 1_000f, 100_000f);
	//Signal = 0
    public static final FloatProperty PROP_RECIEVE_RESISTANCE_MAX =
		new FloatProperty(MoreGrid.MOD_ID, "tranciever.recieve_resistance_max", 16_000f, 1_000f, 100_000f);
