...
public class VariableBuzzerComponent extends ABuzzerComponent {
    private static final ComponentFootprint FOOTPRINT = new ComponentFootprint.Builder(
				3,5, "component." + MoreGrid.MOD_ID + ".buzzer", null)
            .addPad(0, 1, 0)
            .addPad(2, 1, 1)
    ...
    //Hz/A
    public static final FloatProperty PITCH = new FloatProperty(MoreGrid.MOD_ID, "pitch.current", 20000.0f, 5000.0f, 200000.0f);
