...
public class ShuntComponent extends OrientableComponent {
    private static final ComponentFootprint FOOTPRINT = new ComponentFootprint.Builder(
				6,3, "component." + MoreGrid.MOD_ID + ".small_resistor", null)
            .addPad(1, 1, 0)
            .addPad(4, 1, 1)
            .withItem().withOutline().build();

    public static final FloatProperty RESISTANCE = new FloatProperty(MoreGrid.MOD_ID, "resistor_value", 0.01f, 0.0001f, 0.1f);
