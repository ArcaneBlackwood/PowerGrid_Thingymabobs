...
public final class ModModels {
	...
	public static final ResourceLocation SLB_BASE_L = MoreGrid.asResource("small_light_bulb/base_l");
	public static final ResourceLocation SLB_BASE_S = MoreGrid.asResource("small_light_bulb/base_s");
	...
	public static final ResourceLocation TRANS_BASE = MoreGrid.asResource("transceivers/transmitter");
	public static final ResourceLocation RECV_BASE = MoreGrid.asResource("transceivers/reciever");
	public static final ResourceLocation DIRECT_BASE_H = MoreGrid.asResource("transceivers/directional_reciever_h");
	public static final ResourceLocation DIRECT_BASE_V = MoreGrid.asResource("transceivers/directional_reciever_v");
	...
	public static PartialModel component(String path) {
		return PartialModel.of(MoreGrid.asResource("component/"+path));
	}
}
