...
public class MicroRelay extends ARelay {
	...
	protected void addProperties(Builder<ComponentProperty<?>> properties) {
		...
		properties.add(THRESHOLD_VOLTAGE, ENERGIZED, THRESHOLD_CURRENT, POLARIZED, NORMALLY_CLOSED, CURRENT);
	}
    @Override
    ...
    protected void createSwitches(PlacedComponent placed, ComponentCircuitBuilder builder, IEmitter thermals, SwitchBuilder switches) {
        switches.relay(2, 3, placed.get(NORMALLY_CLOSED));
    }
    @Override
