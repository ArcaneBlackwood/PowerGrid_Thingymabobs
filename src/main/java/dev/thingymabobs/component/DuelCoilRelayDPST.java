...
public class DuelCoilRelayDPST extends ARelay {
	private static final ComponentFootprint FOOTPRINT = new ComponentFootprint.Builder(
		...
		.addPadSharedText(3, 0, 4, "noa", "noa.short")
		.addPadSharedText(3, 1, 5, "cca", "cca.short")
		.addPadSharedText(3, 2, 6, "nca", "nca.short")
		.addPadSharedText(4, 0, 7, "nob", "nob.short")
		.addPadSharedText(4, 1, 8, "ccb", "ccb.short")
		.addPadSharedText(4, 2, 9, "ncb", "ncb.short")
    ...
    protected void createSwitches(PlacedComponent placed, ComponentCircuitBuilder builder, IEmitter thermals, SwitchBuilder switches) {
        ...
        switches.wire(7, 8, false);
        switches.wire(9, 8, true);
    }
    @Override
