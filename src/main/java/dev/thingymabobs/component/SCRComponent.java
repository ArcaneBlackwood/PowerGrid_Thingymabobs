...
import dev.thingymabobs.sim.SCRWire;
...
public final class SCRComponent extends MirrorableComponent implements IComponentGoggleInformation {
    ...
    public boolean addToGoggleTooltip(
        ...
        tooltip.add(Component.translatable(
                placed.get(STATE) ? "thingymabobs.tooltip.scr.on" : "thingymabobs.tooltip.scr.off"
        ));
        tooltip.add(Component.translatable(
                "thingymabobs.tooltip.scr.trigger",
                String.format(Locale.ROOT, "%.1f mA", placed.get(TRIGGER_CURRENT) * 1000.0F)
        ));
        tooltip.add(Component.translatable(
                "thingymabobs.tooltip.scr.drop",
