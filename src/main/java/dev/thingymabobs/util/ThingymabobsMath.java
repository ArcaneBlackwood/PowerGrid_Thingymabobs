...
public final class ThingymabobsMath {
    ...
    public static double dryCellOpenVoltage(double stateOfCharge) {
        double soc = clamp01(stateOfCharge);
        if (soc <= 1.0E-6D) {
            return 0.0D;
        }
        return dryCellVoltagePerCell(soc);
    }
    ...
    public static double dryCellInternalResistance(double stateOfCharge) {
        double soc = clamp01(stateOfCharge);
        if (soc <= 1.0E-6D) {
        ...
        return dryCellResistancePerCell(soc);
    }
