...
import dev.thingymabobs.blocks.electricfurnace.ElectricFurnaceRecipe;
...
public enum ModRecipies {
	...
	public static class Registers {
		public static final DeferredRegister<RecipeSerializer<?>> SERIALIZER_REGISTER = DeferredRegister.create(BuiltInRegistries.RECIPE_SERIALIZER, Thingymabobs.MOD_ID);
		public static final DeferredRegister<RecipeType<?>> TYPE_REGISTER = DeferredRegister.create(Registries.RECIPE_TYPE, Thingymabobs.MOD_ID);
	}
	...
	private <T extends RecipeInput, R extends ARecipe<T>> ModRecipies(Supplier<IRecipeFactory<T, R>> newFactory) {
		...
		id = Thingymabobs.asResource(name);
