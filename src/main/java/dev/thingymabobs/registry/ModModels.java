...
public final class ModModels {
	...
	public static final ResourceLocation THI = Thingymabobs.asResource("temperature/thermistor");
	public static final ResourceLocation THI_F = Thingymabobs.asResource("temperature/thermistor_connected_f");
	public static final ResourceLocation THI_FB = Thingymabobs.asResource("temperature/thermistor_connected_fb");
