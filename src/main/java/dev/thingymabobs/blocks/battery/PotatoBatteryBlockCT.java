...
public class PotatoBatteryBlockCT extends ConnectedTextureBehaviour.Base {
	...
	private static final CTSpriteShiftEntry SIDES = CTSpriteShifter.getCT(
                AllCTTypes.RECTANGLE,
                Thingymabobs.asResource("block/battery/potato_battery_side"),
                Thingymabobs.asResource("block/battery/potato_battery_side_connected")
	);

	private static final CTSpriteShiftEntry SIDES_BAKED = CTSpriteShifter.getCT(
                AllCTTypes.RECTANGLE,
                Thingymabobs.asResource("block/battery/baked_potato_battery_side"),
                Thingymabobs.asResource("block/battery/baked_potato_battery_side_connected")
	);
